		...
		<div class="account__sidebar">
			...
			<div class="account__body">
				...
				<div class="account__text">
					<p>На Ваш номер мобильного телефона был выслан временный пароль. Временный пароль активен в течении 300 сек. Вы можете запросить пароль повторно, если его не получили или не успели ввести до окончания срока действия.</p>
					<p>Срок действия временного пароля: 249 сек.</p>
				</div>
				<form action="" class="account__form">
					<div class="field account__field">
						<input type="password" class="field__input" placeholder="Пароль">						
					</div>
					<a href="#" class="account__tool"><i class="icon-repeat"></i> Получить новый код</a>
				</form>
