...
<body>
	<div class="preloader">
		...
		<img src="img/logo.svg" alt="" class="preloader__logo">
		<div class="preloader__counter">100</div>
		<div class="preloader__text">© 2018-2020 ООО «РСХБ-Страхование жизни»</div>
	</div>
	<div class="account">
		<div class="account__sidebar">
			...
			<div class="account__body">
				<ul class="account__menu">
					<li class="active"><a href="account.php">Вход</a></li>
					<li><a href="account-sign-up.php">Регистрация</a></li>
				</ul>
				<form action="" class="account__form">
					<div class="field account__field">
						<i class="icon-info field__icon"></i>
						<input type="text" class="field__input" placeholder="Имя пользователя">
						<span class="field__message">Вы ввели неверный логин или пароль, пожалуйста, попробуйте еще раз</span>						
					</div>
					<div class="field account__field">
						<i class="icon-eye-slash field__icon field__icon--pass"></i>
						<input type="password" class="field__input" placeholder="Пароль">						
					</div>					
					<button class="btn btn--huge btn--yellow btn--block account__submit-btn">Войти</button>
				</form>
				<div class="account__text">
					<p><a href="javascript:;">Не помню пароль</a></p>
				</div>				
			</div>
