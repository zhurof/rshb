		...
		<div class="account__sidebar">
			...
			<div class="account__body">
				...
				<div class="account__text">
					<p>Нам нужно убедиться что вы не робот! <br>Введите текст, изображенный на картинке</p>
				</div>
				<form action="" class="account__form">
					<div class="field field--captcha account__field">
						<img src="img/captcha.png" alt="">		
					</div>
					<div class="field account__field">
						<input type="text" class="field__input" placeholder="Текст с картинки">					
					</div>				
