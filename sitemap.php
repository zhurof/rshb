				...
				<div class="sidebar-page__main">
					...
					<div class="text-block text-block--small-gap">
						<ul>
							...
							<li><a href="property-structure.php" target="_blank">Структура собственности</a></li>
							<li><a href="management.php" target="_blank">Руководство</a></li>
							<li><a href="team.php" target="_blank">Команда</a></li>
							<li><a href="fatca.php" target="_blank">FATCA</a></li>
							<li><a href="news.php" target="_blank">Новости</a></li>
							<li><a href="post.php" target="_blank">Отдельная новость</a></li>
