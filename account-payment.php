		...
		<div class="account__sidebar">
			...
			<div class="account__body">
				<div class="account__text">
					<h3>Оплатить договор по коду</h3>
					<p>Для продолжения покупки страхового продукта укажите Вашу фамилию и код, который был отправлен Вам ранее.</p>
				</div>
				<form action="" class="account__form">
					<div class="field account__field">
						<input type="text" class="field__input" placeholder="Укажите фамилию">					
					</div>
					<div class="field account__field">
						<input type="text" class="field__input" placeholder="Укажите код">					
					</div>	
					<button class="btn btn--huge btn--yellow btn--block account__submit-btn">Продолжить</button>
				</form>
				<div class="account__text">
